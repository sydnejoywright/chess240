...
//    public ChessGame addGame(ChessGame game) throws ResponseException {
...
//    }
    ...
    public AuthtokenData addAuth(String username){
...
//    }
    ...
    public AuthtokenData getAuth(String username){
...
//    }
    ...
    public AuthtokenData deleteAuth(String username){
    ...
    public GameData addGame(String username){

    }

    public GameData getGame(String username){

    }

    public GameData deleteGame(String username){

    }

    public GameData updateGame(String username){
